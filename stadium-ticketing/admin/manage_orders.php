...
try {
   $sql = "
SELECT o.*, u.name AS username, GROUP_CONCAT(DISTINCT e.title) AS event_names
FROM orders o
JOIN users u ON o.user_id = u.id
LEFT JOIN tickets t ON t.user_id = o.user_id
            ...
            <tbody>
                <?php foreach ($orders as $order): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($order['event_names']); ?>  </td>
